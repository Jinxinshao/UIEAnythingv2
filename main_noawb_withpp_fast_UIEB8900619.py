...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_folder', type=str, default='./output_results_UIEB890_noawb_withpp_fast_UIEB8900619', help='Folder to save results')
    ...
    parser.add_argument('--use-gpu', action='store_true', default=True, help='Use GPU for SeaThru if available (PyTorch device selection is separate)')
